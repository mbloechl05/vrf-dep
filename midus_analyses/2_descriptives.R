...
tables <- lapply(data[,c("A1SS7", "A1PRSEX", "A1PB1", "A1SA9S", "A1SA9X", 
                         "A1PA43", "n_rf")], table)
tables
...
vars <- data[,c("A1PAGE_M2", "A1PRSEX", "A1SS7",  "A1PB1", "A1SA9S", "A1SBMI", 
                "A1SA9X", "A1PA43", "w1_deprmean", "w2_deprmean", "w3_deprmean")]  
