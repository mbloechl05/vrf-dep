...
# define model with a linear fit
m.uc <- '
...
# regressions
i ~ w2_age_c + w2_sex + w2_eth + w0_edu + adl
s ~ w2_age_c + w2_sex + w2_eth + w0_edu + adl
'

# fit model (non-linear fit, spline model)
fit.cov <- sem(m.cov, data = data, 
               ordered = c("w2_psceda","w2_pscedb","w2_pscedd", "w2_pscede","w2_pscedg", 
                           "w3_psceda","w3_pscedb","w3_pscedd", "w3_pscede","w3_pscedg",
                           "w4_psceda","w4_pscedb","w4_pscedd", "w4_pscede","w4_pscedg", 
                           "w5_psceda","w5_pscedb","w5_pscedd", "w5_pscede","w5_pscedg", 
...
# regressions
i ~ w2_age_c + w2_sex + w2_eth + w0_edu + pred + int.a + int.s
s ~ w2_age_c + w2_sex + w2_eth + w0_edu + pred + int.a + int.s
'
...
# regressions
i ~ w2_age_c + w2_sex + w2_eth + w0_edu + adl + pred
s ~ w2_age_c + w2_sex + w2_eth + w0_edu + adl + pred
'
