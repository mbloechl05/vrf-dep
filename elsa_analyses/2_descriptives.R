...
# valid Ns)
psych::describe(data[,c("w2_dhager", "w2_bmival", "w2_meansys", "w2_meandias", 
                        "w2_fglu_f", "w2_DhSex", "w2_fqethnr", "w0_educ", "hyp", 
                        "diab", "w2_HESka", "n_rf")]) 

# descriptive stats for dichotomous variables
tables <- lapply(data[,c("w2_DhSex", "w2_fqethnr", "w0_educ", "hyp", "diab", 
                         "w2_HESka", "n_rf")], table)
...
vars <- data[,c("w2_dhager","w2_DhSex", "w2_fqethnr", "w0_educ", "hyp",
                "w2_bmival", "diab",  "w2_HESka", "w2_meansys", "w2_meandias", 
                "w2_fglu_f", "w2_deprmean", "w3_deprmean", "w4_deprmean", 
